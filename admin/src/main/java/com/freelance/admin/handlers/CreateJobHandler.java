...
import com.freelance.admin.model.CategoryInfo;
import com.freelance.admin.model.CreateJobRequest;
import com.freelance.admin.model.CreateJobResponse;
  ...
  public APIGatewayProxyResponseEvent handleRequest(
    ...
    try {
      ...
      if (!AdminAuthUtils.isAdminUser(userId)) {
        return ResponseUtil.createErrorResponse(403, "Forbidden: Only admins can create jobs at this far!");
      }
      ...
      context
              .getLogger()
              .log("Admin creating job: " + userId + ", category: " + request.categoryId());
      ...
      JobEntity jobEntity = createJobEntity(request, userId);
